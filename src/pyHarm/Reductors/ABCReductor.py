...
class ABCReductor(abc.ABC):
    """This is the abstract class ruling the reducers class.

    The reducer is responsible for reducing the size of the system to be solved
    based on different hypotheses.

    Args:
        data (dict): A dictionary containing the reducers parameters.
        expl_dofs (pd.DataFrame): DataFrame describing the positioning of dofs.
          It is generated by ABCSystem objects.
